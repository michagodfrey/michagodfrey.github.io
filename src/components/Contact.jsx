        ...
        <div className="max-w-screen-xl flex flex-col justify-center items-center px-8 lg:px-36 mx-auto h-full w-full">
            <form method="POST" action="https://getform.io/f/7c1a6ab1-0cd7-42d3-8bf0-d9dc5f85fab6" className="flex flex-col max-w-[600px] w-full">
              <div>
                  ...
                  <p className="py-4">Submit the form below or shoot me an email at - <a href="mailto:mail@michael-godfrey.com" className="underline">mail@michael-godfrey.com</a></p>
              </div>
