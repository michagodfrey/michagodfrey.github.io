...
const Home = () => {
  return (
    <div name="home" className="h-screen">
        <div className="max-w-screen-xl mx-auto px-8 lg:px-24 flex flex-col justify-center h-full">
            ...
            <div>
                <button>
                    <Link to="work" smooth={true} duration={500} className="text-white border-2 px-6 py-3 my-2 rounded-lg flex items-center group hover:bg-emerald-600 hover:border-emerald-600">
                        See Work
