...
const Navbar = () => {
    ...
    return (
      <div
        className={`${shadowClass} fixed w-full h-[96px] flex justify-between items-center px-8 bg-[#0a192f] z-10`}
      >
        <div>
        ...
        <ul className="hidden lg:flex text-2xl">
          <li className="mx-6 cursor-pointer">
            <Link
              ...
              offset={-96}
              spy
              activeClass="border-b-4 border-emerald-600"
            >
              Home
            </Link>
          </li>
        ...
        <ul
          className={
            nav
              ? "absolute top-20 left-0 w-full h-screen bg-[#0a192f] text-2xl flex flex-col items-center"
              : "hidden"
          }
        >
          <li className="py-3">
          ...
          <li className="py-3">
            <a
              href="https://www.linkedin.com/in/michael-godfrey-82258bb3/"
              className="flex justify-between items-center"
            >
          ...
          <li className="py-3">
            <a
              href="https://twitter.com/Michael07865192"
              className="flex justify-between items-center"
            >
              X <BsTwitterX size={30} className="ml-4" />
            </a>
          </li>
          {/* <li className="py-3">
            <a
              href="https://docs.google.com/document/d/1jRoP_4aEGobglqGzhDAHdmLf8L9kWNda/edit?rtpof=true"
              className="flex justify-between items-center"
            >
        ...
        <ul className="hidden lg:flex flex-col fixed top-[35%] left-0">
          ...
          <li className="w-[160px] h-[60px] px-4 flex items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#000]">
            <a
              href="https://twitter.com/Michael07865192"
              className="flex justify-between items-center w-full"
            >
          ...
          <li className="w-[160px] h-[60px] px-4 flex items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-emerald-600">
            <a
              href="mailto:mail@michael-godfrey.com"
              className="flex justify-between items-center w-full"
            >
